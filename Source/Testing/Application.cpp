...
const double Sleeper :: sLoadFactor=1.0;
 ...
 void TestApp()
 {
    ...
    Station s4("Kolkata");
    Station s5("Chennai");
    Railways::sStation.push_back(s1);
    Railways::sStation.push_back(s2);
    Railways::sStation.push_back(s3);
    Railways::sStation.push_back(s4);
    Railways::sStation.push_back(s5);
    int index=0;
